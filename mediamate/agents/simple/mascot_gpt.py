"""
This module contains the MascotGPT class which is responsible for generating mascot designs using AI,
and saving the generated mascots to various platforms.
"""
import os.path
import requests
...
class MascotGPT:
    """
    The MascotGPT class handles generating mascot designs using AI and saving the generated mascots to various platforms.
    """
    def __init__(self):
    ...
    async def save_to_xhs(self, seed: int = 3):
        """
        Save the generated mascot to the XHS platform.

        :param seed: The seed for random selection of brand, style, and background color.
        """
        ...
        if media_config:
            for xhs in media_config.get('xhs', []):
                ...
                account_dir = f'{config.DATA_DIR}/upload/{platform}/{account}/mascot_gpt'
    ...
    async def save_to_dy(self, seed: int = 3):
        """
        Save the generated mascot to the DY platform.
