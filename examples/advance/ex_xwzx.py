...
from mediamate.agents.advance.news_template_xwzx import NewsTemplateXwzx
...
async def get_image_news():
    ...
    # 制作新闻的参数
    news_params = {
        'title': script_params.get('title') or '新闻资讯',
        'subtitle': script_params.get('subtitle') or '精彩时刻, 不容错过',
