...
from mediamate.agents.advance.news_template_rdxw import NewsTemplateRdxw
...
async def get_image_news():
    ...
    # 制作新闻的参数
    news_params = {
        'title': script_params.get('title') or '热点新闻',
        'subtitle': script_params.get('subtitle') or '触手可及',
